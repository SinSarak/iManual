namespace iManual.Migrations
{
    ...
    public partial class mainclaim : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.MainClaims", t => t.SubClaimId)
                .Index(t => t.SubClaimId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.MainClaims", "SubClaimId", "dbo.MainClaims");
            ...
            DropIndex("dbo.MainClaims", new[] { "SubClaimId" });
